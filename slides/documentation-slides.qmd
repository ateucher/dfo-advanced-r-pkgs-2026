...
::: {.notes}
Before `@inherit`DotParams`, a user had to navigate to ?cpue, figure out which arguments apply to biomass_index(), and mentally filter. Now they get the answer on the same help page.
:::
