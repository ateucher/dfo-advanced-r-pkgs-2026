...
- [https://github.com/ateucher/fishr.example](https://github.com/ateucher/fishr.example)

![](https://media2.giphy.com/media/v1.Y2lkPTc5MGI3NjExemQ1eGIzeG0yM3RjeHFuN3Rld3c0Mzk3aGI5cWVhY2ZjMGdncDRraSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/b7PrQ32OqlMUZVlxar/giphy.gif)
...
If dev_sitrep suggests package updates, hold off updating them now (but do it later!).
:::
...
2. Populate roxygen tags `@param`, `@return`, and `@examples`
