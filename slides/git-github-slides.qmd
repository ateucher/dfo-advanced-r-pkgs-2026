...
- `"test-coverage"`: Compute test coverage and report at codecov.io (Requires an account and API key)
...
::: {.fragment}
Merge the PR once you're happy with the changes.
...
::: {.notes}
Walk through the GitHub PR creation UI. Title should match the branch intent. 
Body should explain *why*, not just *what* - the diff already shows what changed.
Review, make comments, approve, and merge the PR on GitHub.
:::
