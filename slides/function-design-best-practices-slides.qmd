...
::: {.fragment}
The `air` formatter (already configured in this project) handles this automatically on save.
:::
...
::: {.fragment}
Domain-standard abbreviations are the one acceptable exception to "be verbose".
:::
...
R has a global key-value store packages can use for user-configurable defaults:
