...
-   A computer (preferably with administrative privileges), and a secondary monitor if possible
...
Make sure the version of Rtools matches your version of R (e.g. Rtools44 for R 4.4, Rtools45 for R 4.5).
...
[Air](https://posit-dev.github.io/air) is a code formatter that will automatically format your code to a common style. 
This is a very useful tool for collaborative package development. 
Instructions to install the Air command line tool can be found at: <https://posit-dev.github.io/air/cli.html>.
...
We highly recommend the book [Happy Git with R](https://happygitwithr.com/) for advice on setting up and using Git with R [@bryan].
...
You can now check your Git setup by asking for a "Git situation report" in R:
